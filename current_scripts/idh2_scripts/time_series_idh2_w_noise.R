...
### Last modified on 8/3/2023
### This code runs the FLT3-NPM1-IDH subgroup from the Palma paper (as a time series), gets the network score + rolling mean of network score, and then calculates the final score
