...
rolling_median <- rollmedian(running_mean, k = window)

 hist(time.series[window:n.obs,28],
     xlim = c(-8,2),
     ylim = c(0, 8000),
      main = "Histogram of running mean [1000:20000]",
      xlab = "running mean"
 ...
 hist(rolling_median,
     xlim = c(-4,-2),
     ylim = c(0, 3000),
      main = "Histogram of running median",
      xlab = "rolling median"
...
par(mfrow = c(2,2))
hist(time.series[n.half :n.obs,28],
     xlim = c(-8,2),
     ylim = c(0, 500),
     main = "Histgram of network score [10000:20000]",
     xlab = "Network score"
